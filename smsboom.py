...
def update():
    """从 github 获取最新接口"""
    GETAPI_json_url = f"https://cdn.jsdelivr.net/gh/OpenEthan/SMSBoom@master/GETAPI.json"
    API_json_url = f"https://cdn.jsdelivr.net/gh/OpenEthan/SMSBoom@master/api.json"
